                                              ...
                                              children: [
                                                Row(
                                                  children: [
                                                    ...
                                                    IconButton(
                                                      icon: Image.asset(
                                                          'assets/icons/delete.png',height: 27,),
                                                      onPressed: () {
                                                          ...
                                                          return  AlertDialog(
                                                            ...
                                                            actions: [
                                                              ElevatedButton(
                                                                  ...
                                                                  onPressed: (){
                                                                    _eventsServices.deleteEvent(snapshot
                                                                        .data!
                                                                        .eventDetails!
                                                                        .events![index].event!.eventId!).then((onValue){
                                                              ...
                                                              ElevatedButton(
                                                                  style: ButtonStyle(backgroundColor: WidgetStatePropertyAll(Colors.blue)),
                                                                  onPressed: (){
                                                                    _eventsServices.deleteEventInstance(snapshot
                                                                        .data!
                                                                        .eventDetails!
                                                                        .events![index].eventInstance!.eventInstanceId!).then((onValue){
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Container(
                                                                    ...
                                                                    child: DropdownButtonFormField<
                                                                      ...
                                                                      items: [
                                                                        ..._groupNames.map<DropdownMenuItem<String>>((String
                                                                                value) {
                                                                              return DropdownMenuItem<String>(
                                                                                value: value,
                                                                                child: Text(value),
                                                                    ...
                                                                    onPressed:
                                                                        () async {
                                                                          if (title.text.isNotEmpty &&
                                                                              ...
                                                                              eventLocation.text.isNotEmpty && _selectedGroup != null){
                                                                         ...
                                                                         /*   requestModel.createdBy = await getUserId();
                                                                            ...
                                                                            UpdateEventResponseModel? eventCreatedResponse =
                                                                                await EventsServices().updateEventData(requestModel,   snapshot
                                                                                    .data!
                                                                                    .eventDetails!

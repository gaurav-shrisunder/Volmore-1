...
class PastEventVerificationScreen extends StatefulWidget {
  final String eventInstanceId;
  final Events event;
  final String date;
  const PastEventVerificationScreen({
    super.key,
  ...
  @override
  State<PastEventVerificationScreen> createState() => _PastEventVerificationScreenState();
}

class _PastEventVerificationScreenState extends State<PastEventVerificationScreen> {
